...
[![Deploy to Bluemix](https://bluemix.net/deploy/button.png)](https://bluemix.net/deploy?repository=https://github.com/teja-tummalapalli/node-red-playground-bluemix-starter.git)
